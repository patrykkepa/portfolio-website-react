        ...
        <section class="sectionAbout">
            <div className="e-about">
                ...
                <div className="e-about-right">
                    ...
                    <h1><i class="fas fa-child"></i>Who am I</h1>
            ...
            <div className="e-about">
                ...
                <div className="e-about-right">
                    ...
                    <h1><i class="fas fa-fire"></i>Passion</h1>
            ...
            <div className="e-about">
                ...
                <div className="e-about-right">
                    ...
                    <h1><i class="fas fa-hand-point-right"></i>Future</h1>
            ...
            <div className="e-about">
                ...
                <div className="e-about-right">
                    ...
                    <h1><i class="fas fa-wrench"></i>Tools / workflow</h1>
